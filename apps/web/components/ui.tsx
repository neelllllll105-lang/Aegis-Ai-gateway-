...
export function AttributionChip({
  ...
  return (
    <span
      className={`inline-flex min-w-[80px] items-center justify-center gap-1.5 rounded-full px-3 py-1 text-center text-[10px] font-mono font-bold uppercase tracking-wider ${ATTRIBUTION_STYLES[actor]}`}
    >
      {label}
    </span>
  );
