...
const NAV: { section: string; items: { href: string; label: string; icon: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/budgets", label: "Budgets", icon: "M3 6a2 2 0 012-2h14a2 2 0 012 2v2H3V6zm0 4h18v8a2 2 0 01-2 2H5a2 2 0 01-2-2v-8zm12 4h3" },
    ],
  },
  {
    section: "Account",
    items: [
      { href: "/team", label: "People & Teams", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
...
/** Flattened, for the mobile bar where sections would cost more room than they earn. */
